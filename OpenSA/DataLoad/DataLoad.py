...
def LoadNirtest(type):
    ...
    if type == "Rgs":
        ...
        nowpath    = '/home/rock/biyesheji/OpenSA/OpenSA' 
        # CDataPath1 = nowpath+'.//Data//Rgs//Cdata1.csv'
        # VDataPath1 = nowpath+'.//Data//Rgs//Vdata1.csv'
        # TDataPath1 = nowpath+'.//Data//Rgs//Tdata1.csv'
        ...
        # Nirdata1 = np.concatenate((Cdata1))
